...
from app.backpressure import assert_enqueue_allowed
from app.quota_store import assert_quota_for_enqueue
...
def enqueue_connector_sync(body: dict[str, Any]) -> dict[str, Any]:
    ...
    estimated = int(body.get("chunk_estimate", 1))
    assert_quota_for_enqueue(tenant_id, estimated_chunks=estimated)
